...
public class LoginCheck extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   String fuserid="uid="+n+",ou=demo,o=tushar";
	   
	   LdapConnection lc=new LdapConnection();
	   try {
	   DirContext dc=lc.connectToLDAPAsUser(n, p);
	  ...
	  // DirContext da=lc.ConnectToLDAPAsAdmin();
       ...
       out.println("</head>");
       out.println("<body>");
       out.println("<h2 style=\"color:white\">Password changed successfully</h2>");
       out.println("</body>");
       out.println("</html>");
	 ...
	 out.println("<html>");
     out.println("<body>");
     out.println("<h2 style=\"color:white\">"+finalemsg+"</h2>");
     out.println("</body>");
     out.println("</html>");
	   ...
	   request.getRequestDispatcher("/index.html").include(request, response);
		 ...
		 if(errmsg.contains("Invalid Credentials")) {
			 out.println("<html>");
		     out.println("<body");
		     out.println("<h2 style=\"color:white\">Current Password is incorrect</h2>");
		     out.println("</body>");
		     out.println("</html>");
		 }
